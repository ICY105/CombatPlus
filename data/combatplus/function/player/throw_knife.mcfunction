...
execute if data entity @s SelectedItem.components."minecraft:custom_data".combatplus.knife run scoreboard players set #slot combatplus.data 1
execute if data entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".combatplus.knife run scoreboard players set #slot combatplus.data 2
