...
execute if entity @s[tag=!combatplus.knife.creative] if score #durability combatplus.data matches ..25 run function combatplus:utils/m.spawn_item with entity @s item
