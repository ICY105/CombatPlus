...
#get level
execute store result score temp_5 du_data run data get entity @s HandItems[0].tag.combatplus_id
...
#deal damage
execute if score temp_5 du_data matches 36..37 as @e[type=#du:living,distance=..2,sort=nearest] run function combatplus:damage_entity
execute if score temp_5 du_data matches 38 as @e[type=#du:living,distance=..3,sort=nearest] run function combatplus:damage_entity
execute if score temp_5 du_data matches 39..102 as @e[type=#du:living,distance=..4,sort=nearest] run function combatplus:damage_entity
...
playsound combatplus:arc_star_explode player @a ~ ~ ~ 1 1

#cleanup
execute if entity @s[tag=combatplus_arc_star_tag] run tag @e[tag=combatplus_arc_star_tag,sort=nearest,limit=1,type=#du:living,distance=..3] remove combatplus_arc_star_tag
kill @s
