...
execute if score in_1 du_data matches -3.. store result block -29999999 0 1601 Items[0].tag.AttributeModifiers[{Name:"generic.attackDamage"}].Amount double 1 run scoreboard players get in_1 du_data
...
execute if score in_1 du_data matches -3.. store result block -29999999 0 1601 Items[0].tag.Damage int 1 run scoreboard players get in_1 du_data
