...
execute if data entity @s Inventory[{Slot:-106b}].tag.complus_knife unless data entity @s SelectedItem.tag.complus_knife run scoreboard players set temp_1 du_data 2
execute if data entity @s Inventory[{Slot:-106b}].tag.complus_knife unless data entity @s SelectedItem.tag.complus_knife run replaceitem entity @s[gamemode=!creative] weapon.offhand air

execute if data entity @s SelectedItem.tag.complus_knife run scoreboard players set temp_1 du_data 1
execute if data entity @s SelectedItem.tag.complus_knife run replaceitem entity @s[gamemode=!creative] weapon.mainhand air
