...
execute store result score temp_1 du_data run data get entity @s HandItems[0].tag.complus_id
...
execute as @e[type=#du:living,distance=..1,sort=nearest,limit=1] run tag @s add complus_arc_star_tag
tag @s add complus_arc_star_tag

function complus:proj/arc_star_charge
