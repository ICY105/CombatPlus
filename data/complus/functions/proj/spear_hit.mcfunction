...
execute store result score in_0 du_data run data get entity @s HandItems[0].tag.AttributeModifiers[{Name:"generic.attack_damage"}].Amount 11
...
function complus:proj/spear_end
